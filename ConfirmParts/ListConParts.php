...
<body>
    ...
    <div id="wrapper">
     ...
     AND (m.XVMajStatus = 'รออะไหล่' OR m.XVMajStatus = 'รอช่างรับอะไหล่' OR m.XVMajStatus = 'รอนำรถเข้าซ่อม' OR m.XVMajStatus = 'ดำเนินการซ่อม')"; //แสดงใบแจ้งซ่อมทีเป็นสถานะ "รออนุมัติซ่อม"
    $stmt = $dbh->query($sql);
    $count = 1;
