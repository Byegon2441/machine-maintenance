            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <form action="typeupdate.php" name="frmEdit" method="post">
                                ...
                                <div class="form-group">   
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <input class="form-control" name="typeid" type="text"readonly value="<?php echo $row['typeid'] ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control" name="typename" value="<?php echo $row['typename'] ?>">
                                        </div>
                                    </div>
                                </div>
                                    <center>
