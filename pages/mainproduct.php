                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-2">
                            <button type="button" class="btn btn-success"><a href="productadd.php">เพิ่ม</button>
                            </div>
                        </div>
                        <br>
                                <thead>
                                ...
                                <tbody>
                                    <?php
                                        $sql="SELECT * FROM tbproduct as a INNER JOIN tbdatatype as b ON a.typeid=b.typeid";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="product.php?proid=<?php echo $row['proid']; ?>"><button type="button" class="btn btn-warning">แก้ไข</button></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
