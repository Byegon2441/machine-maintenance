                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="panel-body">
                            <form action="productinsert.php" name="frmEdit" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <input class="form-control" type="text"readonly name="productid" >
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9"><input class="form-control" name="productname">
                        </div>
                            </div>
                        </div>
                            <div class="form-group">
                                ...
                                จำนวน
                                        ...
                                        <div class="col-lg-3">
                                            <input type="number" class="form-control" name="productnum">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <button type="button" class="btn btn-danger"><a href="mainproduct.php ?>">ยกเลิก</button>
                                    </center>
