...
<body>
    ...
    <div id="wrapper">
     ...
     AND m.XVMajStatus = 'รอช่างรับอะไหล่' "; //แสดงใบแจ้งซ่อมทีเป็นสถานะ "รอช่างรับอะไหล่"
    $stmt = $dbh->query($sql);
    $count = 1;
...
?>
                                    ...
                                    <td><?php echo $row["XVMajDocNo"];?></td>
                                        ...
                                        <td align="center"><a class='btn btn-primary editbtn' href="addFixDate.php?id=<?php echo $row["XVMajDocNo"] ?>"
                                                >กำหนดวันนัดซ่อม</a></td>
                                    </tr>
                                    <?php $count++;} ?>
                                </tbody>
                            </table>
