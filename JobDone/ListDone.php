...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">บันทึกการซ่อม</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
     ...
     AND m.XVMajStatus = 'ดำเนินการซ่อม' "; 
    $stmt = $dbh->query($sql);
    $count = 1;
...
?>
                                    ...
                                    <td><?php echo $row["XVMajDocNo"];?></td>
                                        ...
                                        <td align="center"><a class='btn btn-primary editbtn' href="JobDone.php?id=<?php echo $row["XVMajDocNo"] ?>"
                                                >ดูรายละเอียด</a></td>
                                    </tr>
                                    <?php $count++;} 
                                    $dbh = null;
