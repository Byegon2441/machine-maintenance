                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="insertFinish.php" method='POST' class="form-inline">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col text-left">
                                            ...
                                            <label for="numb">วันที่ประเมินเสร็จ : <input id="datepicker" size="6"
                                                    name="XDMajEstActualDate" class="form-control" value="<?php $datecon3 = $row1["XDMajFinishEstDate"];
                                            ...
                                            <label for="numb">วันที่อะไหล่พร้อม : <input id="datepicker" size="6"
                                                    name="XDMajEstActualDate" class="form-control" value="<?php if($row1["XDMajSpareDate"]!= NULL){$datecon5 = $row1["XDMajSpareDate"];
                                            ...
                                            <label for="numb">วันที่ซ่อม : <input id="datepicker" size="6"
                                              ...
                                              <label for="numb">วันที่ซ่อมเสร็จ : <input id="datepicker" size="6"
                                                    name="XDMajEstActualDate" class="form-control" value="<?php if($row1["XDMajFinishRepairDate"]!= NULL){$datecon8 = $row1["XDMajFinishRepairDate"];
                                            ...
                                            <label for="numb">วันที่ปิดงาน : <input id="datepicker" size="6"
