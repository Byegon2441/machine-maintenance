                                    ...
                                    <div class="col-md-6">
                                        <div class="col text-left">
                                            ...
                                            <label for="numb">วันที่รับรถ : <input id="datepicker" size="6"
                                                    name="XDMajPickupActualDate" class="form-control"value="<?php $datecon3 = $row1["XDMajPickupActualDate"];
                                                         $DN3 = str_replace('-', '/', $datecon3);
                                                          $Dnew3 =  date('d/m/Y', strtotime($DN3));
                                                          echo $Dnew3;?>"
                                                    data-toggle="datepicker" disabled>
                                            </label>
                                            <label for="numb">วันที่ปิดงาน : <input id="datepicker" size="6" value="<?php $datecon3 = $row1["XDMajFinishDate"];
                                                         $DN3 = str_replace('-', '/', $datecon3);
                                                          $Dnew3 =  date('d/m/Y', strtotime($DN3));
                                                          echo $Dnew3;?>"
                                    ...
                                    <div class="col-md-6">
                                        <div class="col text-left">
                                            <a type="button" class="btn btn-danger mr-auto"
                                                href="ListFinishDone.php">กลับ</a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="col text-right">
                                            <input type="hidden" value="<?php echo $id?>" name='id'>
                                            หมายเหตุปิดงาน : <input type="text" value="<?php echo $row1["XVMajFinishRmk"];?>" name="XVMajFinishRmk" class="form-control"  disabled>
